...
INSTALLED_APPS = [
    ...
    'django.contrib.auth', #Adds 4 default permissions (Add, Change, Delete, View) for each model
...
MIDDLEWARE = [
    'django.middleware.csrf.CsrfViewMiddleware', #Should always come before SecurityMiddleware and it's for CSRF protection
